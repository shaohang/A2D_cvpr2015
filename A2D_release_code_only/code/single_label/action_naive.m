...
function action_naive(dataset_path,number_clusters)
...
% ** just action
semantic_label = mod(semantic_label,10);
...
save('./data/action_prediction.mat','action_prediction','prob','test_label');
